				...
				args = {
					...
					mail = {
						...
						set = function(_, value)
							...
							MiniMapMailFrame:SetParent(value and Minimap or map)
						end,
					},
					zoneText = {
						name = L.ZONETEXT,
					...
					moveBlizzButtonSelect = {
						...
						values = {zoomIn = L.zoomIn, zoomOut = L.zoomOut, difficulty = L.difficultyIndicator, calendar = L.CALENDAR, mail = L.newMail, pvp = L.classicPvPQueue, lfg = L.classicGroupFinder},
